...
<cfscript>
	...
	{
		get_pallet_list_action = createObject("component", "addOns.ezgi.cfc.get_ezgi_pallets_between_first_warehouse");
...
<div class="col col-12 col-md-12 col-sm-12 col-xs-12">
    ...
    <cfsavecontent variable="title"><cf_get_lang dictionary_id='1309.Giriş Bölümleri Arası Geçiş'></cfsavecontent>
        	...
        	<thead>
            	<tr>
                    ...
                    <th style="width:25px" class="header_icn_none">
                      	<a href="<cfoutput>#request.self#?fuseaction=stock.list_ezgi_pallets_between_first_warehouse&event=add</cfoutput>"><i class="fa fa-plus" title="<cf_get_lang dictionary_id='57582.Ekle'>"></i></a>
            		</th>
                   	<!-- sil -->
              	</tr>
         	</thead>

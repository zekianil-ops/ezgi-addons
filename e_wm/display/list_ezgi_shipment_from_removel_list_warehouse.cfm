...
<div class="col col-12 col-md-12 col-sm-12 col-xs-12">
    ...
    <cfsavecontent variable="title"><cf_get_lang dictionary_id='1347.Sevkiyat Listesinden Çıkartma'></cfsavecontent>
    <cf_box title="#title#" uidrop="1" hide_table_column="1" scroll="1">
                    ...
                    <cfoutput query="get_shipment">
                        <tr height="35px">
                        	<td style="text-align:right">#currentrow#</td>
                          	<td>
                             	<cfset url_param = "#request.self#?fuseaction=stock.list_ezgi_shipment_from_removel_list_warehouse&event=add&DELIVER_PAPER_NO=#DELIVER_PAPER_NO#&is_type=#IS_TYPE#&ship_id=#SHIP_RESULT_ID#&x_select_process_yontem=#x_select_process_yontem#">
        ...
        <cfif isDefined('attributes.removel') and len(attributes.removel) >
        	<cfset adres = "#adres#&removel=#attributes.removel#" >
      	</cfif>
        <cf_paging 

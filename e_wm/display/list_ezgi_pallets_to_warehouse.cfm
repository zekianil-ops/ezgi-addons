...
<cfscript>
	...
	{
		get_pallet_list_action = createObject("component", "addOns.ezgi.cfc.get_ezgi_pallets_to_warehouse");
...
<div class="col col-12 col-md-12 col-sm-12 col-xs-12">
    ...
    <cfsavecontent variable="title"><cf_get_lang dictionary_id='1307.Ambara Transfer İşlemi'></cfsavecontent>
        	...
        	<thead>
            	<tr>
                    ...
                    <th style="width:25px" class="header_icn_none">
                      	<!---<a href="<cfoutput>#request.self#?fuseaction=stock.list_ezgi_pallets_to_warehouse&event=add</cfoutput>"><i class="fa fa-plus" title="<cf_get_lang dictionary_id='57582.Ekle'>"></i></a>--->
            		</th>
                   	<!-- sil -->
              	</tr>
         	</thead>
            	...
            	<cfif get_pallets.recordcount>
                    <cfoutput query="get_pallets">
                        <tr height="25px">
                            ...
                            <td style="text-align:center">#DateFormat(UPDATE_DATE,dateformat_style)# #TimeFormat(UPDATE_DATE,'hh:mm')#</td>
                            <!-- sil -->

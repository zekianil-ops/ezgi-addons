<!---
    File: add_ezgi_pallets_transfer.cfm
    Folder: Add_Ons\ezgi\e_wm\form
    Author: Ezgi Yazılım
    Date: 01/08/2023
    Description: Palet Transfer İşlemi
--->
<cfset default_process_type = 113>
<cfset PACKING_ACTION_TYPE_ID = 3> <!---Palet İşlem Tipi - (Palet Transfer)--->
...
<cfsavecontent variable="title_"><cf_get_lang dictionary_id='1341.Palet Transfer'></cfsavecontent>

<div class="col col-12 col-md-12 col-sm-12 col-xs-12">
	<cf_box>
        <cfform name="add_ezgi_pallets_transfer" >
            ...
            <cf_basket_form id="add_ezgi_pallets_transfer">
                <div class="row">
		...
		else
		{
			...
			else
			{
				...
				else
				{
					...
					if(get_shelves.SHELF_SIZE_TYPE != document.getElementById('SIZE_ID1').value)
					{

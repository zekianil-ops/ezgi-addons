...
<cfoutput>
    ...
    <td style="text-align:right;width:80px">
    	<cfif isdefined('t_#calc#') and isdefined('t1_#left(calc,5)#') and evaluate('t_#calc#') neq 0 and evaluate('t1_#left(calc,5)#') neq 0>
           	<cfset 't2_#calc#' = evaluate('t_#calc#')>
            #Tlformat(evaluate('t_#calc#')/evaluate('t1_#left(calc,5)#')*100,2)#%
        <cfelse>
        	<cfset 't2_#calc#' = 0>
        	0,00%&nbsp;
   		</cfif>
    ...
    <cfswitch expression="#list_type#" >
       	<cfcase value="1">
            <cfloop from="#sene1#" to="#sene2#" index="ii">
                <td style="text-align:right;width:80px">
                    <cfif isdefined('t_#calc#_1_#ii#') and isdefined('t1_#left(calc,5)#_1_#ii#') and evaluate('t1_#left(calc,5)#_1_#ii#') neq 0 and evaluate('t_#calc#_1_#ii#') neq 0>
                    	<cfset 't2_#calc#_1_#ii#' = evaluate('t_#calc#_1_#ii#')>
                        #Tlformat(evaluate('t_#calc#_1_#ii#')/evaluate('t1_#left(calc,5)#_1_#ii#')*100,2)#%
                  	<cfelse>
         	...
         	<cfloop from="#sene1#" to="#sene2#" index="ii">
            	<cfloop from="1" to="#period_say#" index="i">
                	<td style="text-align:right;width:80px;<cfif DayofYear(evaluate('period_flu_#i#_#ii#')) gt DayofYear(period_date_lock) and Year(evaluate('period_flu_#i#_#ii#')) eq Year(period_date_lock)>filter:alpha(Opacity=50,FinishOpacity=40);</cfif>">
                         <cfif isdefined('t_#calc#_#i#_#ii#') and isdefined('t1_#left(calc,5)#_#i#_#ii#') and evaluate('t1_#left(calc,5)#_#i#_#ii#') neq 0 and evaluate('t_#calc#_#i#_#ii#') neq 0>
                        	<cfset 't2_#calc#_#i#_#ii#' = evaluate('t_#calc#_#i#_#ii#')>
                            #Tlformat(evaluate('t_#calc#_#i#_#ii#')/evaluate('t1_#left(calc,5)#_#i#_#ii#')*100,2)#%
                       	<cfelse>

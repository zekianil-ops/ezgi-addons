<!---
    File: list_ezgi_default_piece.cfm
...
<cfscript>
	get_piece.recordcount=0;
	get_piece.query_count=0;
	if (isdefined("attributes.is_submitted"))
	{
		get_piece_list_action = createObject("component", "addOns.ezgi.cfc.get_piece");
		get_piece_list_action.dsn3 = dsn3;
		get_piece = get_piece_list_action.get_piece_
		(
...
<cfparam name="attributes.totalrecords" default='#get_piece.query_count#'>
<div class="col col-12 col-md-12 col-sm-12 col-xs-12">
    ...
    <cfsavecontent variable="title"><cfoutput><cf_get_lang dictionary_id="852.Default Parça Listesi"></cfoutput></cfsavecontent>
    <cf_box title="#title#" uidrop="1" hide_table_column="1" scroll="1">
     	<cf_grid_list>
          	<thead>
            	<tr>
                	<th width="20"><cf_get_lang dictionary_id="58577.Sıra"></th>
            		<th><cf_get_lang dictionary_id='841.Parça ID'></th>
            		<th><cf_get_lang dictionary_id="853.Parça Kodu"></th>
           			<th><cf_get_lang dictionary_id="854.Default Parça Adı"></th>
      				<th><cf_get_lang dictionary_id="57899.Kaydeden"></th>
					<th><cf_get_lang dictionary_id="57627.Kayıt Tarihi"></th>
							<!-- sil -->
            			<th width="20" class="header_icn_none">
                        	<a href="<cfoutput>#request.self#?fuseaction=prod.list_ezgi_default_piece&event=add</cfoutput>"><i class="fa fa-plus" title="<cf_get_lang dictionary_id='57582.Ekle'>"></i></a>
            			</th>
                   	<!-- sil -->
             	</tr>
         	</thead>
          	<tbody>
            	<cfif get_piece.recordcount>
                	<cfoutput query="get_piece">
						<tr oncontextmenu="javascript:wrk_right_menu('PIECE_DEFAULT_ID',#PIECE_DEFAULT_ID#);return false;"> 
                        	<td>#rownum#</td>
                         	<td style="text-align:center">#PIECE_DEFAULT_ID#</td>
                       		<td style="text-align:center">
                             	<a href="#request.self#?fuseaction=prod.list_ezgi_default_piece&event=upd&piece_ID=#PIECE_DEFAULT_ID#" class="tableyazi">#PIECE_DEFAULT_CODE#</a>
                         	</td>
                         	...
                         	<td>#get_emp_info(RECORD_EMP,0,0)# </td>
                          	...
                          	<!-- sil -->
                                <td>
                                    <a href="#request.self#?fuseaction=prod.list_ezgi_default_piece&event=upd&piece_ID=#PIECE_DEFAULT_ID#"><i class="fa fa-pencil" title="<cf_get_lang dictionary_id='57464.Güncelle'>" alt="<cf_get_lang dictionary_id='57464.Güncelle'>"></i></a>
                                </td>
                         	<!-- sil -->
                     	</tr>
               		</cfoutput>

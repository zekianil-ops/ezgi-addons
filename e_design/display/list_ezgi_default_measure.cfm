<!---
    File: list_ezgi_default_measure.cfm
...
<cfscript>
	get_measure.recordcount=0;
	get_measure.query_count=0;
	if (isdefined("attributes.is_submitted"))
	{
		get_measure_list_action = createObject("component", "addOns.ezgi.cfc.get_measure");
		get_measure_list_action.dsn3 = dsn3;
		get_measure = get_measure_list_action.get_measure_
		(
...
<cfparam name="attributes.totalrecords" default='#get_measure.query_count#'>
<div class="col col-12 col-md-12 col-sm-12 col-xs-12">
    ...
    <cfsavecontent variable="title"><cf_get_lang dictionary_id="36568.Ölçü Adları"></cfsavecontent>
    <cf_box title="#title#" uidrop="1" hide_table_column="1" scroll="1">
     	<cf_grid_list>
          	<thead>
            	<tr>
                	<th width="20"><cf_get_lang dictionary_id="58577.Sıra"></th>
            		<th><cf_get_lang dictionary_id="851.Ölçü ID"></th>
            		<th><cf_get_lang dictionary_id="36570.Ölçü Kodu"></th>
           			<th><cf_get_lang dictionary_id="36569.Ölçü Adı"></th>
      				<th><cf_get_lang dictionary_id="57899.Kaydeden"></th>
           			<th><cf_get_lang dictionary_id="57627.Kayıt Tarihi"></th>
            		<!-- sil -->
            			<th width="20" class="header_icn_none">
                        	<a href="<cfoutput>#request.self#?fuseaction=prod.list_ezgi_default_measure&event=add</cfoutput>"><i class="fa fa-plus" title="<cf_get_lang dictionary_id='57582.Ekle'>"></i></a>
            			</th>
                   	<!-- sil -->
             	</tr>
         	</thead>
          	<tbody>
            	<cfif get_measure.recordcount>
                	<cfoutput query="get_measure">
						<tr oncontextmenu="javascript:wrk_right_menu('measure_ID',#measure_ID#);return false;"> 
                        	<td>#rownum#</td>
                         	<td style="text-align:center">#measure_ID#</td>
                       		<td style="text-align:center">
                             	<a href="#request.self#?fuseaction=prod.list_ezgi_default_measure&event=upd&measure_id=#measure_ID#" class="tableyazi">#MEASURE_CODE#</a>
                         	</td>
                          	<td>#measure_NAME#</td>
                         	<td>#get_emp_info(RECORD_EMP,0,0)# </td>
                          	...
                          	<!-- sil -->
                                <td>
                                    <a href="#request.self#?fuseaction=prod.list_ezgi_default_measure&event=upd&measure_id=#measure_ID#"><i class="fa fa-pencil" title="<cf_get_lang dictionary_id='57464.Güncelle'>" alt="<cf_get_lang dictionary_id='57464.Güncelle'>"></i></a>
                                </td>
                         	<!-- sil -->
                     	</tr>
               		</cfoutput>

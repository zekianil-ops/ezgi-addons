<cfscript>
    if (attributes.tabMenuController eq 0)
    {
        ...
        WOStruct['#attributes.fuseaction#']['list']['fuseaction'] = 'sales.list_ezgi_shipping_reservation_demand';
        WOStruct['#attributes.fuseaction#']['list']['filePath'] = '/AddOns/ezgi/e_shipping/display/list_ezgi_shipping_reservation_demand.cfm';
	
		WOStruct['#attributes.fuseaction#']['upd'] = structNew();
        WOStruct['#attributes.fuseaction#']['upd']['window'] = 'normal';
        WOStruct['#attributes.fuseaction#']['upd']['fuseaction'] = 'sales.list_ezgi_shipping_reservation_demand&event=upd';
        WOStruct['#attributes.fuseaction#']['upd']['filePath'] = '/AddOns/ezgi/e_shipping//form/upd_ezgi_shipping_reservation_demand.cfm';
        WOStruct['#attributes.fuseaction#']['upd']['queryPath'] = '/AddOns/ezgi/e_shipping//query/upd_ezgi_shipping_reservation_demand.cfm';
	...
	else
	{
		...
		if(isdefined("caller.attributes.event") and caller.attributes.event is 'upd')
		{
			...
			tabMenuStruct['#fuseactController#']['tabMenus']['upd']['icons']['list-ul']['href'] = "#request.self#?fuseaction=list_ezgi_shipping_reservation_demand";

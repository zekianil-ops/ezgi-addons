...
<cfscript>
    if (attributes.tabMenuController eq 0)
    {
        ...
        WOStruct['#attributes.fuseaction#']['list']['fuseaction'] = 'sales.list_ezgi_shipping';
        WOStruct['#attributes.fuseaction#']['list']['filePath'] = '/AddOns/ezgi/e_shipping/display/list_ezgi_shipping.cfm';
	...
	else
	{
		...
		if(isdefined("caller.attributes.event") and caller.attributes.event is 'upd')
		{
			...
			tabMenuStruct['#fuseactController#']['tabMenus']['upd']['icons']['list-ul']['href'] = "#request.self#?fuseaction=sales.list_ezgi_shipping";

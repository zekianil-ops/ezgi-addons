<!---
    File: dsp_ezgi_iflow_operational_fullness.cfm
        ...
        FROM            
            ...
            (
				...
				GROUP BY 
                	OPERATION_ID, 
                    STATION_ID
            ) AS TBL ON TBL.OPERATION_ID = PORR.P_OPERATION_ID AND TBL.STATION_ID = PORR.STATION_ID
  		WHERE  
    ...
    <cf_box scroll="0">
        ...
        <div class="col col-12 col-md-12 col-sm-12 col-xs-12">
            <cfform action="" name="search_list" method="post">
                <cfsavecontent variable="title"><cf_get_lang dictionary_id='1377.İstasyon Doluluk Raporu'></cfsavecontent>
                <cf_box title="#title#">
                	<cfset dikey = 1>
                    <cfset yatay = 1>
                    <cfif isdefined("attributes.is_form_submitted")>
                        ...
                        <cfloop query="get_station_sablon">
                            ...
                            <cfloop query="get_sub_stations">
                                ...
                                <cfquery name="get_doluluk" dbtype="query">
                                    ...
                                    WHERE 
                                    	STATION_ID = #get_sub_stations.STATION_ID#
                                </cfquery>
                                <div class="col col-3">
                                    <table width="100%" height="300px" cellpadding="2" cellspacing="0" border="1">
                                        ...
                                        <tr>
                                            ...
                                            <td width="50%" style="text-align:center" class="box_yazi">
                                                <cfoutput>
													<cfif len(get_doluluk.DOLULUK) and isnumeric(get_sub_stations.EZGI_KATSAYI)>
                                        ...
                                        <tr>
                                            <td style="text-align:center" height="200px">
                                                ...
                                                <cfif isnumeric(get_doluluk.DOLULUK) and isnumeric(get_sub_stations.EZGI_KATSAYI)>

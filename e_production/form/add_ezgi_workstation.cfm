...
<div class="col col-12 col-md-12 col-sm-12 col-xs-12">
	<cfform name="add_workstation" method="post" action="#request.self#?fuseaction=prod.add_ezgi_workstation_process">
	<cf_catalystHeader> 
		<cf_box>
			<cf_box_elements>
	                ...
	                <div class="form-group" id="item-cost">
	                    ...
	                    <div class="col col-8 col-xs-12">
		                    <div class="input-group">
								<cfinput type="text" name="cost" id="cost" required="yes" maxlength="10" onkeyup="FormatCurrency(this,event,8)" class="moneybox" value="1">
	            ...
	            <div class="col col-4 col-sm-4 col-xs-12" type="column" index="2" sort="true">
                    ...
                    <div class="form-group" id="item-katsayi">
                    	...
                    	<div class="col col-8 col-xs-12">
							<input name="ezgi_katsayi" id="ezgi_katsayi" type="text" value="1" onKeyup="return(FormatCurrency(this,event,2));" class="moneybox"/>
                   		</div>
                  	</div>
                  	<div class="form-group" id="item-oreder_control">
                  	    ...
                  	    <div class="col col-8 col-xs-12">
                  	        <select name="ezgi_order_control" id="ezgi_order_control">
                  	       		<option value="0"><cf_get_lang dictionary_id='1066.Tüm Emirler'></option>
                  	         	<option value="1"><cf_get_lang dictionary_id='1358.Planlı Emirler'></option>
                  	   		</select>
                  	    </div>
                  	</div>
                  	<div class="form-group" id="item-package_control">
                  	    ...
                  	    <div class="col col-8 col-xs-12">
								<select name="ezgi_package_control" id="ezgi_package_control">
                  	         	...
                  	         	<option value="1" ><cf_get_lang dictionary_id='39093.Ürün Barkod'></option>
                  	         	<option value="2" ><cf_get_lang dictionary_id='39093.Ürün Barkod'> + <cf_get_lang dictionary_id='833.Paket Ekle'></option>
                  	            <option value="3" ><cf_get_lang dictionary_id='36815.Grupla'> <cf_get_lang dictionary_id='61695.Üret'></option>
                  	            <option value="4" >Takip No Kontrol</option>
                  	            <option value="5" >Hızlı Üret</option>
                  	            <option value="6" >Şablon Bazlı Üretim</option>
								<option value="7" >Şartlı Liste</option>
                  	   		</select>
                  	    </div>
                  	</div>
                  	<div class="form-group" id="item-previous_operation_end_control">
                  	    ...
                  	    <div class="col col-8 col-xs-12">
								<select name="previous_operation_end_control" id="previous_operation_end_control">
                  	         	...
                  	         	<option value="1" ><cf_get_lang dictionary_id='58467.Başlama'> <cf_get_lang dictionary_id='37999.Takibi Yapılsın'></option>
                  	            <option value="3" ><cf_get_lang dictionary_id='57502.Bitiş'> <cf_get_lang dictionary_id='37999.Takibi Yapılsın'></option>
                  	   		</select>
                  	    </div>
                  	</div>
                  	<div class="form-group" id="item-setting_period_hour">
                  	    ...
                  	    <div class="col col-8 col-xs-12">
								<input name="ezgi_setup_time" id="ezgi_setup_time" type="text" value="0" onKeyup="return(FormatCurrency(this,event,0));" class="moneybox"/>
                  	    </div>
                  	</div>
                  	<input name="setting_period_hour" id="setting_period_hour" type="hidden" value="0" onKeyup="return(FormatCurrency(this,event,0));" class="moneybox"/>
                  	<input name="setting_period_minute" id="setting_period_minute" type="hidden" value="0" onKeyup="return(FormatCurrency(this,event,0));" class="moneybox"/>
                  	...
                  	<div class="form-group" id="item-trimming">
                  	    ...
                  	    <div class="col col-8 col-xs-12">
                  	        <div class="col col-12 col-xs-12">
                  	            <input type="text" name="trimming" id="trimming" value="0" onKeyup="return(FormatCurrency(this,event,1));" class="moneybox"/>
                  	        </div>
                  	    </div>
                  	</div>
                   		<div class="form-group" id="item-thickness">
                  	    ...
                  	    <div class="col col-8 col-xs-12">
                  	        <div class="col col-12 col-xs-12">
                  	            <input type="text" name="thickness" id="thickness" value="0" onKeyup="return(FormatCurrency(this,event,1));" class="moneybox"/>
                  	        </div>
                  	    </div>
                  	</div>
                  	<div class="form-group" id="item-cutting_method">
                  	    ...
                  	    <div class="col col-8 col-xs-12">
                  	    	<select name="cutting_method" id="cutting_method">
                  	         	<option value="1" >Saf Guillotine</option>
                  	            <option value="2" >Hibrit (Best-Fit)</option>
                  	   		</select>
                  	    </div>
                  	</div>
                  	<div class="form-group" id="item-max_number">
                  	    ...
                  	    <div class="col col-8 col-xs-12">
                  	        <div class="col col-12 col-xs-12">
                  	            <input type="text" name="max_number" id="max_number" value="1" onKeyup="return(FormatCurrency(this,event,0));" class="moneybox"/>
                  	        </div>
                  	    </div>
                  	</div>
                  	...
                  	<div class="form-group" id="item-rotate">
                  	    ...
                  	    <div class="col col-8 col-xs-12">
                  	        <div class="col col-12 col-xs-12">
                  	            <input type="text" name="max_different_cuts" id="max_different_cuts" value="999" onKeyup="return(FormatCurrency(this,event,0));" class="moneybox"/>
                  	        </div>
                  	    </div>
                  	</div>
                  	<div class="form-group" id="item-cutting_direction">
                  	    ...
                  	    <div class="col col-8 col-xs-12">
                  	    	<select name="cutting_direction" id="cutting_direction">
                  	         	<option value="1" >Plaka Dikey Kesim</option>
                  	            <option value="2" >Plaka Yatay Kesim</option>
                  	   		</select>
                  	    </div>
                  	</div>
                 	<!---Ezgi Yazılım Özelleştirme--->

                ...
                <cfif get_analyst_branch.recordcount>
                    <cfoutput query="get_analyst_branch" startrow="#attributes.startrow#" maxrows="#attributes.maxrows#">
                        ...
                        <tr>
                            ...
                            <td style="text-align:right">#TlFormat(sonuc_total_sales,2)#</td>
                            <td style="text-align:right">#TlFormat(sonuc_smm+sonuc_total_expense,2)#</td>
                            <td style="text-align:right;background-color:<cfif sonuc_total_sales-sonuc_smm-sonuc_total_expense gt 0>PaleTurquoise<cfelseif sonuc_total_sales-sonuc_smm-sonuc_total_expense lt 0>Bisque</cfif>">
                            	#TlFormat(sonuc_total_sales-sonuc_smm-sonuc_total_expense,2)#	  
                            </td>

...
<cftransaction>
	<cflock timeout="90">
       ...
       <!--- Master Paketlerin Listesini Çekiyorum--->
        ...
        <!---Mobilya Tasarımda Eski PaketBilgilerini Spect Main ID üzerinden Buluyorum.--->
        ...
        <cfloop list="#row_info_content#" index="i">
            ...
            <cfif get_change_spect_main_row.AMOUNT eq change_amount>
                ...
                <!---MOBİLYA TASARIM--->
                <cfquery name="del_piece_from_old_package_piece_rows" datasource="#dsn3#">
                	DELETE FROM 
                		EZGI_DESIGN_PIECE_ROWS
                    WHERE 
                        PIECE_ROW_ID = #get_piece_for_new_package.PIECE_ROW_ID#
            ...
            <cfelse><!---Eğer Eklenecek Satırla Bölünecek satırların miktarı farklıysa Bölünecek pakettlen ilgili satırı güncelliyorum. --->
                ...
                <!---MOBİLYA TASARIM--->
                	<cfquery name="upd_piece_from_old_package_piece_rows" datasource="#dsn3#">
                        UPDATE 
                            EZGI_DESIGN_PIECE_ROWS
                      	SET
                        	PIECE_AMOUNT = PIECE_AMOUNT-#change_amount#
                        WHERE 
                            PIECE_ROW_ID = #get_piece_for_new_package.PIECE_ROW_ID#
                    </cfquery>

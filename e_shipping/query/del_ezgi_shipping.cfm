...
<cfif attributes.type eq 1>   
	<cfquery name="GET_PACKAGE" datasource="#dsn3#">
		...
		FROM     
            ...
            EZGI_SHIP_RESULT_ROW AS ESRR ON ORR.ORDER_ROW_ID = ESRR.ORDER_ROW_ID ON S.STOCK_ID = ORR.STOCK_ID
		WHERE  
        	S.IS_KARMA = 1 AND 
        	ESRR.SHIP_RESULT_ROW_ID = #attributes.ship_result_row_id#
    </cfquery>

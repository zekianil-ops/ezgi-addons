...
<cfif get_shippng_plan.recordcount>
    ...
    <cfif get_general_info.IS_SERIAL_CONTROL_LOCATION>
        <cfquery name="get_shipping_serial_control" datasource="#dsn3#">
            ...
            FROM     
                ORDER_ROW AS ORR INNER JOIN
                EZGI_SHIP_RESULT_ROW AS ESR ON ORR.ORDER_ROW_ID = ESR.ORDER_ROW_ID INNER JOIN
                EZGI_WM_SERIAL_NO_LAST_STATUS AS EVM ON ESR.SHIP_RESULT_ID = EVM.SHIP_RESULT_ID
            WHERE  
                EVM.SHIP_RESULT_TYPE = 1 AND 
...
<cfsavecontent variable="title_"><cf_get_lang dictionary_id='1117.E-Shipping Güncelle'></cfsavecontent>
<cfsavecontent variable="right_menu_">
	<cfif ListFind(session.ep.power_user_level_id,2178)>
	 	<a href="<cfoutput>#request.self#?fuseaction=sales.popup_upd_ezgi_shipping_divide&ship_id=#attributes.iid#&is_type=1</cfoutput>" class="tableyazi"><img src="images/clinick.gif"  title="" border="0"></a>&nbsp;&nbsp;
  	</cfif>
</cfsavecontent>
                                ...
                                <cf_box_elements>
                                        ...
                                        <div class="form-group" id="item-company">
	                            			...
	                            			<div class="col col-8 col-xs-12">
                                             	<input type="hidden" name="consumer_id" id="consumer_id" value="<cfoutput>#get_shippng_plan.consumer_id#</cfoutput>">
                                              	...
                                              	<input type="text" name="company" id="company" value="<cfoutput>#get_par_info(get_shippng_plan.company_id,1,0,0)#</cfoutput>" readonly>
                                          	</div>
                                      	</div>
                                      	<div class="form-group" id="item-yetkili">
	                            			...
	                            			<div class="col col-8 col-xs-12">
                                             	<cfif Len(get_shippng_plan.CONSUMER_ID)>
                                                    <input type="text" name="member_name" id="member_name" value="<cfoutput>#get_cons_info(get_shippng_plan.CONSUMER_ID,0,0)#</cfoutput>" readonly>
                                                <cfelse>
                                                    <input type="text" name="member_name" id="member_name" value="<cfoutput>#get_par_info(get_shippng_plan.partner_id,0,-1,0)#</cfoutput>" readonly>
                                                </cfif>
                                          	</div>
                                     	</div>
                                    ...
                                    <div class="col col-6 col-xs-12" type="column" index="2" sort="true">
                                    	<div class="form-group" id="item-paper">
	                            			...
	                            			<div class="col col-8 col-xs-12">
                                             	<input name="transport_no1" id="transport_no1" type="text" value="<cfoutput>#get_shippng_plan.DELIVER_PAPER_NO#</cfoutput>" readonly>
                                          	</div>
                                     	</div>
